        ...
        <form class=" form-add-product" method="POST" enctype="multipart/form-data"
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter blog title" name="title" tabindex="0" value="{{old('title')}}" aria-required="true" required="">
                ...
                <fieldset class="name">
                    ...
                    <input type="text" name="tags" class="form-control w-100" data-role="tagsinput" value="{{ old('tags') }}">
                    <div class="text-danger">
                        {{ $errors->first('tags') }}
                    </div>
                </fieldset>
                ...
                <fieldset class="description">
                    ...
                    <textarea id="editor1" class="mb-10" name="content" placeholder="Content"
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product Meta title" name="meta_title" tabindex="0" value="{{old('meta_title')}}" aria-required="true">
                    <div class="text-danger">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product Meta keywords" name="meta_keywords" tabindex="0" value="{{old('meta_keywords')}}" aria-required="true">
                    <div class="text-danger">
                ...
                <fieldset class="name">
                    ...
                    <textarea class="mb-10" type="text" placeholder="Enter product Meta description" name="meta_description" tabindex="0" aria-required="true">{{old('meta_description')}}</textarea>
                    <div class="text-danger">
        ...
        $("#gFile").on('change', function(e) {
            ...
            $.each($gphotos, function(index, file) {
                ...
                reader.onload = function(e) {
                    $("#galUpload").append('<div class="item"><img src="' + e.target.result + '" alt=""></div>');
                }
