        ...
        <form class="form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.blog.store') }}" id="blog-form">
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter author name" name="author" tabindex="0" value="{{ old('author') }}" aria-required="true"
                    required >
                ...
                <fieldset class="name">
                    ...
                    <input type="text" class="mb-10" placeholder="Enter Image Alt tag" name="alt_tag" value="{{ old('alt_tag') }}">
