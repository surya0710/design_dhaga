        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.category.store')}}" method="POST"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Page heading" name="page_heading" tabindex="0" value="{{old('page_heading')}}" aria-required="true">
                </fieldset>
                @error('page_heading')
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Image Alt Tag" name="alt_tag"  value="{{ old('alt_tag') }}" aria-required="true">
                </fieldset>
                @error('page_heading')
                    <p class="invalid-feedback">{{$message}}</p>
                @enderror
