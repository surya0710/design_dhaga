        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" method="GET" action="{{ route('admin.contact.view') }}">
                        <fieldset class="name">
                            <input type="text" placeholder="Search contact queries..." class="" name="search"
            ...
            <div class="flex items-center justify-between flex-wrap gap10 wgp-pagination">
                {{ $contactQueries->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
</div>
