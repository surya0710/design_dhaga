    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li><i class="icon-chevron-right"></i></li>
                <li>
                    <div class="text-tiny">Edit Item</div>
                </li>
            </ul>
        </div>

        <div class="wg-box">
            <form action="{{ route('admin.menu-items.update', [$menu->id, $menuItem->id]) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="wg-box">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('label') is-invalid @enderror"
                                   ...
                                   name="label" value="{{ old('label', $menuItem->label) }}" required>
                            @error('label')
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('url') is-invalid @enderror"
                                   ...
                                   name="url" value="{{ old('url', $menuItem->url) }}">
                            @error('url')
                                <div class="text-danger mt-5">{{ $message }}</div>
                            @enderror
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('route_name') is-invalid @enderror"
                                   ...
                                   name="route_name" value="{{ old('route_name', $menuItem->route_name) }}">
                            @error('route_name')
                                <div class="text-danger mt-5">{{ $message }}</div>
                            @enderror
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('route_params') is-invalid @enderror"
                                   ...
                                   name="route_params"
                                   value="{{ old('route_params', $menuItem->route_params ? json_encode($menuItem->route_params) : '') }}">
                            @error('route_params')
                                <div class="text-danger mt-5">{{ $message }}</div>
                            @enderror
                        </fieldset>
                    ...
                    <div class="wg-box">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow"
                                   ...
                                   name="icon" value="{{ old('icon', $menuItem->icon) }}">
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="select">
                                <select name="target" class="flex-grow">
                                    <option value="_self"
                                            {{ old('target', $menuItem->target) === '_self' ? 'selected' : '' }}>
                                        Same Tab (_self)
                                    </option>
                                    <option value="_blank"
                                            {{ old('target', $menuItem->target) === '_blank' ? 'selected' : '' }}>
                                        New Tab (_blank)
                                    </option>
                                </select>
                            </div>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow"
                                   ...
                                   value="{{ old('order', $menuItem->order) }}" min="0">
                        </fieldset>
                            ...
                            <div class="d-flex gap-3">
                                <label class="d-flex align-items-center gap-2">
                                    <input type="radio" name="is_active" value="1"
                                           {{ old('is_active', $menuItem->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Active
                                </label>
                                <label class="d-flex align-items-center gap-2">
                                    <input type="radio" name="is_active" value="0"
                                           {{ old('is_active', $menuItem->is_active ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Inactive
                                </label>
                            </div>
                        </fieldset>
                ...
                <div class="bot">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="tf-button w208" type="submit">Update Item</button>
                    </div>
                </div>
