...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <form class="form-new-product form-style-1" action="{{ route('admin.pages.update',$page->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="field-group">
                    ...
                    <input type="text" name="heading" placeholder="Enter page heading (h1)" value="{{ old('heading', $page->heading) }}" >
                ...
                <fieldset class="field-group">
                    ...
                    <textarea name="content"
                              class="editor">{{ old('content',$page->content) }}</textarea>
                ...
                <fieldset class="field-group">
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item"
                             id="imgpreview"
                             style="{{ $page->meta_image ? '' : 'display:none' }}">

                            <img id="previewImg"
                                 src="{{ $page->meta_image ? asset('uploads/pages/'.$page->meta_image) : '' }}"
                                 class="effect8">
                ...
                <fieldset class="field-group">
                    ...
                    <select name="status">
                        ...
                        <option value="0"
                            {{ old('status',$page->status) == 0 ? 'selected' : '' }}>
                            Inactive
                        </option>
