...
@section('og_image', asset('frontend_assets/images/og-home.jpg'))
    ...
    @section('content')
        <section class="container py-5">
            ...
            <div class="row py-3 justify-content-center">
                <div class="col-md-10 contact-details col-sm-12">
                    <h4><strong>Office</strong> : {{ $settings->office_address }}</h4>
                    <h4><strong>Store</strong> : {{ $settings->store_address }}</h4>
                    ...
                    <h4><strong>Email</strong> : <a href="mailto:{{ $settings->support_email }}">{{ $settings->support_email }}</a></h4>
        ...
        <section class="container py-5" id="form">
            <div class="row">
                <h1 class="text-center">From Thought to Form</h1>
            </div>
