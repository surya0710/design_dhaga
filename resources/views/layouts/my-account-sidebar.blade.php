    ...
    <div class="sidebar-account">
        ...
        <ul class="my-account-nav">
            ...
            <li>
                <a href="{{route('logout')}}" class="my-account-nav-item">
                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 12H20" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M10 19L20 5" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M6 19L16 5" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                    Logout
                </a>
            </li>
